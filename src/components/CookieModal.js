...
const CookieModal = () => {
  ...
  const acceptCookies = () => {
    ...
    cookies.set("customAdvertisements", cookieSettings.customAdvertisements, {
      path: "/",
    });
    cookies.set(
    ...
    cookies.set("sharingOfSocialMedia", cookieSettings.sharingOfSocialMedia, {
      path: "/",
    });
            ...
            <div className="start">
              ...
              <div className="para">
                <p style={{ margin: "0 0   20px" }}>
                  نحن نستخدم ملفات تعريف الارتباط لتحسين تجربتك. باستمرار زيارتك
                  لهذا الموقع, فإنك توافق على استخدامنا لملفات تعريف الارتباط.
                </p>
              </div>
            </div>
            <div className="end">
          ...
          <Modal.Body>
            <Form>
              <Form.Check
                ...
                onChange={() =>
                  handleCookieSettingsChange("customAdvertisements")
                }
              />
              <Form.Check
                type="checkbox"
              ...
              <Form.Check
                ...
                onChange={() =>
                  handleCookieSettingsChange("sharingOfSocialMedia")
                }
              />
              <Form.Check
                type="checkbox"
